...
import risk from './information.png';

/* shamelessly copied balloon from Shizukulchi */
function Balloon({ startAfter = 3000, duration = 20000 }) {
      ...
      <Div show={show}>
        <div className="balloon__container">
          ...
          <p className="balloon__text__first">
            Double click on icons to open them.
          </p>
        </div>
      </Div>
    )
